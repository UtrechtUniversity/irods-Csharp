...
namespace irods_Csharp
{
    ...
    public class DataObj : ITaggable, IDisposable
    {
        ...
        public void Dispose()
        {
            Packet<OpenedDataObjInp_PI> descRequest = new Packet<OpenedDataObjInp_PI>(ApiNumberData.DATA_OBJ_CLOSE_AN)
            {
        ...
        {
            Packet<OpenedDataObjInp_PI> writeRequest = new Packet<OpenedDataObjInp_PI>(ApiNumberData.DATA_OBJ_WRITE_AN)
            {
        ...
        {
            Packet<OpenedDataObjInp_PI> readRequest = new Packet<OpenedDataObjInp_PI>(ApiNumberData.DATA_OBJ_LSEEK_AN)
            {
        ...
        public byte[] Read(int length = -1)
        {
            ...
            Packet<OpenedDataObjInp_PI> readRequest = new Packet<OpenedDataObjInp_PI>(ApiNumberData.DATA_OBJ_READ_AN)
            {
